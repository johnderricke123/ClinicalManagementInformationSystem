...
@section('manager_manage_employee_account')
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Manage an account</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                                                ...
                                                <form method="post" action="/ManagerEditClientWaitingList/{{$wl->id}}">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="editAppointmentReason">Username:</label>
                                                            <input type="text" class="form-control" value="{{$wl->AppointmentReason}}" name="AppointmentReason">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="editAppointmentReason">First Name:</label>
                                                            <input type="text" class="form-control" value="{{$wl->AppointmentReason}}" name="AppointmentReason">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="editAppointmentReason">Last Name:</label>
                                                            <input type="text" class="form-control" value="{{$wl->AppointmentReason}}" name="AppointmentReason">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="editAppointmentReason">User Role:</label>
                                                            <input type="text" class="form-control" value="{{$wl->AppointmentReason}}" name="AppointmentReason">
                                                        </div>
                                                        <div class="form-group">
